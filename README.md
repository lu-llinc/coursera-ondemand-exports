...
If you look at some of the headers that are supplied in the .html files, you see that some of them contain header specifications that are illegal in e.g. MySQL. Of course, you can choose to not use these header files and use another database. However, PostGreSQL can import CSV files pretty painlessly. 
